...
add_long_configs = op_bench.cross_product_configs(
    M=[8, 128], N=[32, 64], K=[256, 512], device=["cpu", "cuda"], tags=["long"], dtype=[torch.float]
)
...
op_bench.generate_pt_gradient_test(addmm_long_configs + add_short_configs, AddmmBenchmark)
...
op_bench.generate_pt_gradient_test(addbmm_long_configs + addbmm_short_configs, AddbmmBenchmark)
